...
describe('ProjectConfigComponent', () => {
    ...
    beforeEach(() => {
        mockGetAuthorizationService = jasmine.createSpyObj('GetAuthorizationService', ['checkIfSuperUser']);
        let mockRouter: Router;
        component = new ProjectConfigComponent(mockGetAuthorizationService, mockRouter);
    });
