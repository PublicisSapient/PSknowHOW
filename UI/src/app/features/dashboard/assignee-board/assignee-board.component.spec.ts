...
describe('AssigneeBoardComponent', () => {
    ...
    it('should set currentSprint on ngOnInit', () => {
        sharedServiceSpy.currentSelectedSprint = {
            ...
            "labelName": "sprint",
            "parentId": [
                "PSKnowHOW_6577d731cd826638f6964f4d"
            ],
            "sprintState": "ACTIVE",
            "level": 6
        };
        component.ngOnInit();
        expect(component.currentSprint).toBe(sharedServiceSpy.currentSelectedSprint);
    });
    ...
    it('should set currentIssueIndex and filteredIssueDataList on ngOnChanges', () => {
        ...
        component.ngOnChanges({
            issueDataList: {
                ...
                previousValue: undefined, firstChange: false,
        ...
        expect(component.filteredIssueDataList).toEqual([{ id: 2, title: 'Issue 2' }]);
    });
    ...
    it('should set currentIssueIndex and call setIssueData with the correct argument on onPreviousIssue', () => {
        ...
        expect(component.currentIssueIndex).toBe(0);
        expect(sharedServiceSpy.setIssueData).toHaveBeenCalledWith({ id: 1, title: 'Issue 1', 'Issue Status': 'Open' });
    });
    ...
    it('should set currentIssueIndex and call setIssueData with the correct argument on onNextIssue', () => {
        ...
        expect(sharedServiceSpy.setIssueData).toHaveBeenCalledWith({ id: 2, title: 'Issue 2', 'Issue Status': 'In Progress' });
    });
    ...
    it('should set selectedTaskStatusFilter and call filterTasksByStatus on taskFilterSelected', () => {
        ...
        expect(component.filteredIssueDataList).toEqual([{ id: 1, title: 'Issue 1', 'Issue Status': 'Open' }]);
    });
