                    ...
                    if (err.status === 401) {
                        if (requestArea === 'internal') {
                            ...
                            if(!environment.SSO_LOGIN){
                                ...
                                let origin_uri = window.location.origin+'/#/authentication';
                                window.location.href = environment.CENTRAL_LOGIN_URL + '?origin_uri=' + origin_uri + '&redirect_uri=' + redirect_uri;
