...
import { ScoreCard } from 'src/app/model/ScoreCard';
import { KPIScore } from 'src/app/model/KPIScore';
import { NotificationResponseDTO } from 'src/app/model/NotificationDTO.model';
import { UserNameRequestDTO } from 'src/app/model/UserNameRequestDTO';
import { UserAccessApprovalResponseDTO, UserAccessReqPayload } from 'src/app/model/userAccessApprovalDTO.model';
@Injectable({
  providedIn: 'root',
})
