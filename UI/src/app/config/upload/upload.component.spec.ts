...
describe('UploadComponent', () => {
  ...
  beforeEach((() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [HttpService, SharedService, MessageService, GetAuthService, GetAuthorizationService,
        HelperService, DatePipe, ExcelService
  ...
  it('should get saveTestExecutionPercent response as Unauthorized', () => {
    ...
    spyOn(httpService, 'saveTestExecutionPercent').and.returnValue(of(fakeResponse))
    component.submitTestExecution();
  });
      ...
      const filterData = [
        {
          level: 1,
          filterData: [
            { nodeId: 1, isSelected: true, level: 2 },
          ],
        },
        {
          level: 2,
  ...
  it('should set the logoImage and resolve with isImageFit as true if the image dimensions are within the limits', fakeAsync((done) => {
  ...
  it('should disable save and set error message when automatedTestCases or automatableTestCases are not filled', () => {
    ...
    expect(component.testExecutionErrorMessage).toBe('Please fill Automated Test Case & Automatable Test Case both');
  });
  ...
  it('should disable save and set error message when automatedTestCases is greater than automatableTestCases', () => {
    ...
    expect(component.isTestExecutionSaveDisabled).toBeTrue();
    expect(component.testExecutionErrorMessage).toBe('Please fill Automated Regrassion & Total Regrassion both');
  });
  ...
  it('should handle image size validation correctly when image is too large', async () => {
    ...
    expect(component.error).toBe('Image is too big(300 x 150). The maximum dimensions are 250 x 100 pixels');
