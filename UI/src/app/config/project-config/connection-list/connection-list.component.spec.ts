...
describe('ConnectionListComponent', () => {
  ...
  const getConnectionsResponse = {
    message: 'Found all connectionData',
    success: true,
    data: [
      {
        id: '601a3fd369515b0001fe072e',
        type: 'Jira',
        connectionName: 'jira connection',
        cloudEnv: false,
        baseUrl: 'https://test.com/jira',
        username: 'tst-11',
        apiEndPoint: 'rest/api/1.0',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-03T06:16:51',
        updatedAt: '2021-03-25T03:37:42',
      ...
      {
        id: '601baea569515b0001d6816c',
        type: 'Jenkins',
        connectionName: 'testjenkins',
        cloudEnv: false,
        baseUrl: 'http://10.148.241.13:8080/',
        username: 'user- speedy_test',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-04T08:21:57',
        updatedAt: '2021-03-25T09:40:03',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '6020f77ee077d700018adc4a',
        type: 'Sonar',
        connectionName: 'Sonar DOJO',
        cloudEnv: false,
        baseUrl: 'https://test.com/sonar',
        username: 'tst-1',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-08T08:34:06',
        updatedAt: '2021-03-25T09:39:41',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '602117b2e077d700018adc59',
        type: 'Sonar',
        connectionName: 'DOJO Sonar',
        cloudEnv: false,
        baseUrl: 'https://test.com/sonar',
        username: 'ritsharm0',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-08T10:51:30',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '602267059c0b1500015c011e',
        type: 'GitLab',
        connectionName: 'ndsb fan',
        cloudEnv: false,
        baseUrl: 'dsbfn/fgdsg',
        username: 'fdsfdsg',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-09T10:42:13',
        updatedAt: '2021-02-09T10:42:26',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '6023b045b86e73000106d5fc',
        type: 'Jenkins',
        connectionName: 'Jenkins',
        cloudEnv: false,
        baseUrl: 'http://10.148.241.13:8080/',
        username: 'svc-apac-ps-fcadevop',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-10T10:07:01',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '60263c56387a4900015537ef',
        type: 'NewRelic',
        connectionName: 'TestConnectionRishabhNewRelic',
        cloudEnv: false,
        apiEndPoint:
          'https://insights-api.newrelic.com/v1/accounts/729003/query?nrql=',
        isOAuth: false,
        apiKeyFieldName: 'X-Query-Key',
        offline: false,
        createdAt: '2021-02-12T08:29:10',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '60263d17387a4900015537f0',
        type: 'GitLab',
        connectionName: 'TestConnectionRishabhGitLab',
        cloudEnv: false,
        baseUrl: 'https://pscode.lioncloud.net',
        username: 'risshukl0',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-12T08:32:23',
        updatedAt: '2021-02-12T08:32:52',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '60263d95387a4900015537f1',
        type: 'Azure',
        connectionName: 'TestConnectionRishabhAzureBoards',
        cloudEnv: false,
        baseUrl: 'https://dev.azure.com/sundeepm/AzureSpeedy',
        username: 'risshukl0',
        isOAuth: false,
        offline: false,
        createdAt: '2021-02-12T08:34:29',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '603f67f5ec57dc0001405ebf',
        type: 'AzureRepository',
        connectionName: 'AzureRepo1',
        cloudEnv: false,
        baseUrl: 'https://dev.azure.com/ankbhard/KnowHOW',
        isOAuth: false,
        offline: false,
        createdAt: '2021-03-03T10:41:57',
        updatedAt: '2021-03-25T09:37:06',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '603f6a8bec57dc0001405ec3',
        type: 'Bamboo',
        connectionName: 'BambooTool1',
        cloudEnv: false,
        baseUrl: 'https://test.com/bamboo/browse/BAMUP',
        username: 'tst-1',
        isOAuth: false,
        offline: false,
        createdAt: '2021-03-03T10:52:59',
        updatedAt: '2021-03-25T09:37:59',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '6040a1683b3af5000151b2b6',
        type: 'Sonar',
        connectionName: 'sonartest123',
        cloudEnv: false,
        baseUrl: 'https://test.com/sonar/',
        username: 'sansharm13',
        isOAuth: false,
        offline: false,
        createdAt: '2021-03-04T08:59:21',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '6040d76b3b3af5000151b3be',
        type: 'AzurePipeline',
        connectionName: 'Azure-pipline-conn1',
        cloudEnv: false,
        baseUrl: 'https://dev.azure.com/sundeepm/AzureSpeedy',
        isOAuth: false,
        offline: false,
        createdAt: '2021-03-04T12:49:47',
        updatedAt: '2021-03-25T09:37:23',
        createdBy: 'superadmin2',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['superadmin2'],
      },
      {
        id: '6041ac7f3b3af5000121a690',
        type: 'Bitbucket',
        connectionName: 'bitbucket test connection',
        cloudEnv: false,
        baseUrl: 'https://test.com/KNOW/KnowHOWRepo',
        username: 'tst-1',
        apiEndPoint: '/bitbucket/rest/api/1.0/',
        isOAuth: false,
        offline: false,
        createdAt: '2021-03-05T03:58:55',
        updatedAt: '2021-04-01T11:58:50',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
      ...
      {
        id: '605c5bfbf0fb3000015e96d1',
        type: 'Teamcity',
        connectionName: 'Teamcity',
        cloudEnv: false,
        baseUrl: 'https://budp-tc.bunnings.com.au/',
        username: 'speedysvc@publicissapient.com',
        isOAuth: false,
        offline: false,
        createdAt: '2021-03-25T09:46:35',
        createdBy: 'SUPERADMIN',
        connPrivate: false,
        updatedBy: 'SUPERADMIN',
        connectionUsers: ['SUPERADMIN'],
