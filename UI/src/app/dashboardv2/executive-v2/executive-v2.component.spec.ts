...
describe('ExecutiveV2Component', () => {
  ...
  beforeEach(() => {
    ...
    component.receiveSharedData({
        ...
        kpiList: [
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measures the percentage of tickets that passed QA with no return transition or any tagging to a specific configured status and no linkage of a defect',
                formula: [
                  {
                    lhs: 'FTPR',
                    operator: 'division',
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measures the total number of defect created and linked to stories in a sprint against the size of stories in the same sprint',
                formula: [
                  {
                    lhs: 'Defect Density',
                    operator: 'division',
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measures the percentage of defects leaked from the QA (sprint) testing stage to the UAT/Production stage',
                formula: [
                  {
                    lhs: 'DSR for a sprint',
                    operator: 'division',
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measures the percentage of defect rejection  based on status or resolution of the defect',
                formula: [
                  {
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measures the number of defects grouped by root cause in an iteration',
                formula: [
                  {
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Comparative view of number of defects created and number of defects closed in an iteration.',
                details: [
                  {
                    type: 'link',
                    kpiLinkDetail: {
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measure the outcome of sprint as planned estimate vs actual estimate',
                details: [
                  {
                    type: 'paragraph',
                    value:
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Measures the time taken for a builds of a given Job.',
                details: [
                  {
                    type: 'link',
                    kpiLinkDetail: {
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Cost of delay (CoD) is a indicator of the economic value of completing a feature sooner as opposed to later.',
                formula: [
                  {
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'PI predictability is calculated by the sum of the actual value achieved against the planned value at the beginning of the PI',
                details: [
                  {
                    type: 'link',
                    kpiLinkDetail: {
          ...
          },
          {
            ...
            kpiDetail: {
              ...
              kpiInfo: {
                definition:
                  'Scope churn explains the change in the scope of the sprint since the start of the iteration',
                formula: [
                  {
                    lhs: 'Scope Churn',
                    operator: 'division',
      ...
      filterData: [
        ...
        {
          nodeId:
            'Nestle ESAR Optifast Site Implementation_661f831be52b5f05e28b7fac',
        ...
        {
          nodeId:
            'Nestle Starbucks Re-Design and Development 2021 - Phase3: Rollout ( SBUX -MF)_623072e6e0790f028edbb45d',
          nodeName:
            'Nestle Starbucks Re-Design and Development 2021 - Phase3: Rollout ( SBUX -MF)',
        ...
        {
          nodeId:
            'Unified Commerce - BWS Implementation_66332eefe9a65c03fc07af7e',
  ...
  describe('ExecutiveV2 handleSelectedOptionOnBacklog', () => {
    ...
    describe('handleSelectedOptionOnBacklog', () => {
      ...
      it('should call getChartDataForBacklog, createBackupOfFiltersSelection, and setKpiSubFilterObj', () => {
        ...
        expect(component.getChartDataForBacklog).toHaveBeenCalledWith(
          'kpi-1',
          -1,
          'sum',
        );
  ...
  describe('setFilterValueIfAlreadyHaveBackup', () => {
    it('should set the filter value and call getDropdownArray for selectedTab other than "backlog"', () => {
      ...
      component.setFilterValueIfAlreadyHaveBackup(
        kpiId,
        refreshValue,
        initialValue,
        filters,
    ...
    it('should set the filter value and call getDropdownArrayForCard for selectedTab "backlog" without chartType', () => {
      component.selectedTab = 'backlog';
      component.kpiSelectedFilterObj = {};
      component.updatedConfigGlobalData = [{ kpiId: 'kpi1', kpiDetail: {} }];
      const kpiId = 'kpi1';
      const refreshValue = 'refresh1';
      const initialValue = 'initial1';
      const filters = {};
  ...
  describe('handleSelectedOptionOnBacklog', () => {
    it('should handle selected option for single dropdown', () => {
      ...
      expect(
        component.helperService.createBackupOfFiltersSelection,
      ).toHaveBeenCalledWith(component.kpiSelectedFilterObj, 'backlog', '');
    ...
    it('should handle selected option for multi dropdown', () => {
      ...
      component.kpiSelectedFilterObj = {
        kpi1: { filter1: ['previousValue'], filter2: ['previousValue'] },
      };
      spyOn(component, 'getChartDataForBacklog');
      spyOn(component.helperService, 'createBackupOfFiltersSelection');
      spyOn(component.service, 'setKpiSubFilterObj');
    ...
    it('should handle selected option for single dropdown with existing backup', () => {
      ...
      expect(component.kpiSelectedFilterObj).toEqual({
        kpi1: { filter1: ['value1'], filter2: ['previousValue'] },
      });
      expect(component.getChartDataForBacklog).toHaveBeenCalledWith(
        'kpi1',
        -1,
