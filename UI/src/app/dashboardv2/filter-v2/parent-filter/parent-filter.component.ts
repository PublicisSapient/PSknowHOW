...
export class ParentFilterComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['parentFilterConfig']) {
      if (
        changes['parentFilterConfig'].currentValue['labelName'] ===
        'Organization Level'
      ) {
        ...
        this.stateFilters =
          this.helperService.getBackupOfFilterSelectionState('parent_level');
        ...
        this.stateFilters =
          this.helperService.getBackupOfFilterSelectionState('primary_level');
        Promise.resolve().then(() => {
