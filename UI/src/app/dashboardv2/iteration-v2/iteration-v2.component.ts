...
@Component({
  selector: 'app-iteration-v2',
  templateUrl: './iteration-v2.component.html',
  styleUrls: ['./iteration-v2.component.css']
})
export class IterationV2Component implements OnInit, OnDestroy {
