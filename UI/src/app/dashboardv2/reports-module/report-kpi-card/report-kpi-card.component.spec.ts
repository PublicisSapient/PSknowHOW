  ...
  describe('ReportKpiCardComponent.convertToHoursIfTime() convertToHoursIfTime method', () => { 
    describe('Happy paths', () => {
      it('should convert value to hours when unit is "days"', () => {
        ...
        spyOn(kpiHelperService, 'convertToHoursIfTime').and.returnValue(expectedHours as any);
        ...
        expect(kpiHelperService.convertToHoursIfTime).toHaveBeenCalledWith(value, unit);
      });
      ...
      it('should return the same value when unit is not time-related', () => {
        ...
        const value = 100;
        const unit = 'units';
        spyOn(kpiHelperService, 'convertToHoursIfTime').and.returnValue(value as any);
    ...
    describe('Edge cases', () => {
      ...
      it('should handle null value gracefully', () => {
        ...
        const value = null;
        const unit = 'hours';
        spyOn(kpiHelperService, 'convertToHoursIfTime').and.returnValue(null as any);
