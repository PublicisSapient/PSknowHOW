    ...
    if (this.value !== undefined) {
      ...
      this.data?.forEach((eachData, iterator) => {
        svgLegends
          ...
          .html(
            eachData.data
              ? eachData.data + ': ' + eachData.count
              : Object.keys(eachData)[0] +
                  ': ' +
                  eachData[Object.keys(eachData)[0]],
          );
      });
      ...
      var arc = d3
        .arc()
        .innerRadius(radiusNum)
        .outerRadius(radiusNum + thickness)
        .startAngle(0)
        .endAngle(function (d) {
