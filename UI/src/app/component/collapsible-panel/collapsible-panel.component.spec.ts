...
describe('CollapsiblePanelComponent', () => {
  ...
  describe('onSelectionChange', () => {
    it('should update accordionData based on selected hierarchy nodeIds', () => {
      ...
      expect(component.accordionData).toEqual([
        component.rawData[0]
      ]);
    });
  ...
  describe('filterByHierarchyNodeId', () => {
    it('should filter data by hierarchy nodeIds', () => {
      ...
      const filteredResults = component.filterByHierarchyNodeId(component.rawData, nodeIds);
  ...
  describe('setUpPanel', () => {
    it('should correctly set filter data from sharedService', () => {
      ...
      expect(component.filterDataArr).toEqual(sharedService.getDataForSprintGoal().filterDataArr);
  ...
  describe('buildFilterDropdown', () => {
    ...
    it('should return undefined if selected level is not found', () => {
      component.filterRawData = { ...sharedService.getDataForSprintGoal(), selectedLevel: { nodeName: "NonExistingLevel" } };
