...
describe('IterationComponent', () => {
          ...
          modalValues: [
            {
              ...
              description:
                'GS | UI| My dashboard page will be the landing page in case of ping federate  (all data API call to be initiated post successful login)',
            ...
            },
            {
              ...
              description:
                'GS | Backend| By pass knowHOW security flow in case of ping federate (conditional bean loading (Auth to work after disabling springboot security',
            ...
            },
            {
              ...
              description:
                'GS | Backend| Super Admin to add permission to project/ by giving a SSO ID (pre-authorize)',
            ...
            },
            {
              ...
              description:
                'GS | Backend| All notification alert should bypass kafka flow in case of GS',
              issueStatus: 'In Analysis',
              issueType: 'Story',
            },
            {
              ...
              description:
                'GS |- Devops | Pass authentication type and apigateway  URL (kong ) as environment variable',
              issueStatus: 'Ready for Testing',
              issueType: 'Story',
            },
            {
          ...
          value: [
            {
              ...
              sprintNames: ['DTS |Test1 |ITR_1|OpenSource_Scrum Project'],
            ...
            },
            {
              ...
              sprintNames: ['DTS| Test1|PI_10|Opensource_Scrum Project'],
              sprojectName: 'Scrum Project',
            },
          ],
          maturity: '3',
  ...
  const fakeJiraNoFilter = [
    {
      kpiId: 'kpi81',
      kpiName: 'Stories Without Estimate',
      value: [
        { data: 'Total Issues', count: 12 },
        { data: 'Issues Without Estimate', count: 0 },
      ],
      unit: '%',
      maxValue: '500',
      chartType: '',
      id: '605e281c3a5c2e37eedfef72',
      isDeleted: 'False',
      ...
      trendValueList: [
        {
          ...
          value: [
            {
              data: '0',
              sSprintID: '29752_Test1Project_605af167f0fb3000015e6358',
              sSprintName: 'PS HOW |PI_4|ITR_6|10_Mar_Test1Project',
              howerValue: { 'Total Issues': 12, 'Issues Without Estimate': 0 },
              startDate: '10-Mar-2021',
              endDate: '24-Mar-2021',
              sprojectName: 'Test1Project',
            },
          ],
        },
      ],
    ...
    {
      kpiId: 'kpi115',
      kpiName: 'Missing Work Logs',
      value: [
        { data: 'Total Issues(excluding open and dropped)', count: 12 },
        { data: 'Issues Without Worklog', count: 12 },
        { data: 'Total Issues(including open and dropped)', count: 12 },
      ],
      unit: '%',
      maxValue: '500',
      chartType: '',
      id: '605e281c3a5c2e37eedfef6a',
      isDeleted: 'False',
      kpiCategory: 'Iteration',
      kpiUnit: '%',
      kanban: false,
          ...
          value: [
            {
              ...
              value: 100,
              howerValue: {
                'Total Issues(excluding open and dropped)': 12,
                'Issues Without Worklog': 12,
                'Total Issues(including open and dropped)': 12,
              },
              startDate: '10-Mar-2021',
              endDate: '24-Mar-2021',
              sprojectName: 'Test1Project',
    ...
    },
    {
      ...
      value: [
        { data: 'Estimated Effort (in hours)', count: 288, value: '100.0%' },
        { data: 'Actual Effort (in hours)', count: 0, value: '0.0%' },
      ],
      unit: '%',
      maxValue: '',
      chartType: '',
      id: '605e281c3a5c2e37eedfef6c',
      isDeleted: 'False',
      kpiCategory: 'Iteration',
      kpiUnit: '%',
      kanban: false,
          ...
          value: [
            {
              ...
              sSprintName: 'PS HOW |PI_4|ITR_6|10_Mar_Test1Project',
              howerMap: {
                'Estimated Effort (in hours)': [288, 100],
                'Actual Effort (in hours)': [0, 0],
              },
              startDate: '10-Mar-2021',
              endDate: '24-Mar-2021',
              sprojectName: 'Test1Project',
    ...
    {
      kpiId: 'kpi76',
      kpiName: 'Story Completion',
      value: [
        { data: 'Completed Issues', count: 7 },
        { data: 'Total Issues', count: 12 },
      ],
      unit: '%',
      maxValue: '500',
      chartType: '',
      id: '605e281c3a5c2e37eedfef6d',
      isDeleted: 'False',
      kpiCategory: 'Iteration',
      kpiUnit: '%',
      kanban: false,
          ...
          value: [
            {
              ...
              howerValue: { 'Completed Issues': 7, 'Total Issues': 12 },
              startDate: '10-Mar-2021',
              endDate: '24-Mar-2021',
              sprojectName: 'Test1Project',
            },
    ...
    {
      kpiId: 'kpi77',
      kpiName: 'Sprint Velocity (LOE Based)',
      value: [
        { data: 'Team Logged efforts (in hours)', count: 0 },
        { data: 'Delivered Story Points', count: 24 },
      ],
      unit: '',
      maxValue: '500',
      chartType: '',
      id: '605e281c3a5c2e37eedfef6e',
      isDeleted: 'False',
      kpiCategory: 'Iteration',
      kpiUnit: '',
      kanban: false,
          ...
          value: [
            {
              ...
              value: 0,
              howerValue: {
                'Team Logged efforts (in hours)': 0,
                'Delivered Story Points': 24,
              },
              startDate: '10-Mar-2021',
              endDate: '24-Mar-2021',
              sprojectName: 'Test1Project',
    ...
    {
      kpiId: 'kpi78',
      kpiName: 'Actual vs Remaining',
      value: [
        { data: 'Actual Effort (in hours)', count: 0, value: '0.0%' },
        { data: 'Remaining Effort (in hours)', count: 288, value: '100.0%' },
      ],
      unit: '%',
      maxValue: '500',
      chartType: '',
      id: '605e281c3a5c2e37eedfef6f',
      isDeleted: 'False',
      kpiCategory: 'Iteration',
      kpiUnit: '%',
      kanban: false,
          ...
          value: [
            {
              ...
              howerMap: {
                'Actual Effort (in hours)': [0, 0],
                'Remaining Effort (in hours)': [288, 100],
              },
              startDate: '10-Mar-2021',
              endDate: '24-Mar-2021',
              sprojectName: 'Test1Project',
          ...
          value: [
            {
              ...
              howerValue: {
                'Total Defects': 1334,
                'Defects Without Story Link': 698,
              },
              sprojectName: 'Test1Project',
            },
          ],
  ...
  const dashConfigData = {
    ...
    data: [
      ...
      {
        kpiId: 'kpi992',
        kpiName: 'Jira Tech Debt',
        isEnabled: true,
        kanban: true,
      },
      {
        kpiId: 'kpi991',
        kpiName: 'Jenkins Code Build Time',
        isEnabled: true,
        kanban: true,
      },
      {
      ...
      {
        kpiId: 'kpi988',
        kpiName: 'Engg Maturity',
        isEnabled: true,
        kanban: true,
      },
      { kpiId: 'kpi3', kpiName: 'DoR To DoD', isEnabled: true, kanban: false },
      {
        kpiId: 'kpi5',
      ...
      {
        kpiId: 'kpi14',
        kpiName: 'Defects Injection Rate',
        isEnabled: true,
        kanban: false,
      },
      {
      ...
      {
        kpiId: 'kpi28',
        kpiName: 'Defect Count By Priority (tagged to Story)',
        isEnabled: true,
        kanban: false,
      },
      {
      ...
      {
        kpiId: 'kpi36',
        kpiName: 'Defect Count By RCA (tagged to Story)',
        isEnabled: true,
        kanban: false,
      },
      {
      ...
      { kpiId: 'kpi43', kpiName: 'Crash Rate', isEnabled: true, kanban: false },
      {
        kpiId: 'kpi46',
        kpiName: 'Sprint Capacity',
        isEnabled: true,
        kanban: false,
      },
      { kpiId: 'kpi47', kpiName: 'Throughput', isEnabled: true, kanban: false },
      {
        kpiId: 'kpi48',
      ...
      {
        kpiId: 'kpi50',
        kpiName: 'Ticket Count by Priority',
        isEnabled: true,
        kanban: true,
      },
      {
        kpiId: 'kpi51',
        kpiName: 'Ticket Count By RCA',
        isEnabled: true,
        kanban: true,
      },
      { kpiId: 'kpi52', kpiName: 'Throughput', isEnabled: true, kanban: true },
      { kpiId: 'kpi53', kpiName: 'Cycle Time', isEnabled: true, kanban: true },
      {
        kpiId: 'kpi54',
        kpiName: 'Ticket Open rate by Priority',
        isEnabled: true,
        kanban: true,
      },
      {
        kpiId: 'kpi55',
        kpiName: 'Ticket Re-open rate by Priority',
        isEnabled: true,
        kanban: true,
      },
      {
        kpiId: 'kpi56',
        kpiName: 'Work in Progress vs Closed',
        isEnabled: true,
        kanban: true,
      },
      {
        kpiId: 'kpi57',
        kpiName: 'Ticket Throughput',
        isEnabled: true,
        kanban: true,
      },
      {
    ...
    const filterData = {
      ...
      filterData: [
        {
          ...
          labelName: 'sprint',
          parentId: ['DEMO_SONAR_63284960fdd20276d60e4df5'],
          sprintState: 'ACTIVE',
          level: 6,
        },
      ],
      filterApplyData: {
        ...
        selectedMap: {
          ...
          subaccount: [],
          project: [],
          sprint: ['38998_DEMO_SONAR_63284960fdd20276d60e4df5'],
          sqd: [],
        },
        level: 6,
      },
  ...
  it('should evalvate the aggregated expression', () => {
    let aggregatedArr = [
      ...
      },
      {
        ...
        value: 88.89,
        expressions: ['First Time Pass Stories', 'Total Stories', 'percentage'],
        value1: null,
        modalValues: null,
      },
    ];
  ...
  it('should evalvate average the aggregated expression', () => {
    let aggregatedArr = [
      ...
      },
      {
        label: 'First Time Pass Rate %',
        value: 88.89,
        expressions: ['First Time Pass Stories', 'Total Stories', 'average'],
        value1: null,
        modalValues: null,
      },
    ];
  ...
  it('should not save filter table columns on apply click ', () => {
    ...
    const spypostKpiColumnConfig = spyOn(
      httpService,
  ...
  it('should sort the array alphabetically', () => {
    const objArray = [{ data: 'c' }, { data: 'a' }, { data: 'b' }];
    const sortedArray = component.sortAlphabetically(objArray);
    expect(sortedArray).toEqual([{ data: 'a' }, { data: 'b' }, { data: 'c' }]);
  });
  ...
  it('should generate table column data', () => {
    ...
    // Assert
    expect(component.tableColumnData[colName1]).toEqual([
      { name: colData1, value: colData1 },
      { name: colData2, value: colData2 },
    ]);
    expect(component.tableColumnData[colName2]).toEqual([
      { name: colData1, value: colData1 },
      { name: colData2, value: colData2 },
    ]);
