...
describe('FilterComponent', () => {
  ...
  const fakeSelectedFilterArray = [
    {
      ...
      labelName: 'sprint',
      parentId: ['ADDD_649a920fdf3e6c21e3968e30'],
      sprintState: 'ACTIVE',
      level: 6,
    },
  ];
  ...
  beforeEach(() => {
    const routes: Routes = [{ path: 'dashboard', component: FilterComponent }];
  ...
  xit('checking master data on load', () => {
    ...
    httpService.getMasterData().subscribe((masterData) => {
      expect(component.masterData.kpiList.length).toBe(
        fakeMasterData.kpiList.length,
      );
    });
  ...
  it('should get Hierarchy levels when hierarchy  is null', fakeAsync(() => {
    const spy = spyOn(httpService, 'getAllHierarchyLevels').and.returnValue(
      of(fakeFilterData),
    );
  ...
  it('should get  masterData', fakeAsync(() => {
    ...
    const spyHttpgetMasterData = spyOn(
      httpService,
      'getMasterData',
    ).and.returnValue(of(fakeMasterData));
  ...
  it('should process filter data when filter data is comming', () => {
    ...
    const spy = spyOn(component, 'processFilterData');
    const spygetFilterData = spyOn(
      httpService,
      'getFilterData',
    ).and.returnValue(of(fakeFilterData));
    component.getFilterDataOnLoad();
    expect(spy).toHaveBeenCalled();
  });
  ...
  it('should get kpiorder list', fakeAsync(() => {
    component.kpiListData = {};
    const spy = spyOn(httpService, 'getShowHideOnDashboard').and.returnValue(
      of(configGlobalData),
    );
  ...
  it('should handle iteration filter for active sprints', () => {
    component.filterForm = new UntypedFormGroup({
      ...
      selectedSprintValue: new UntypedFormControl(
        '40201_HvyVrzlpld_63b81ef5224e7b4d03186dab',
      ),
    });
  ...
  it('should get processor trace log details and selectedProjectData should be there', () => {
    ...
    spyOn(component, 'findTraceLogForTool');
    spyOn(component, 'showExecutionDate');
    component.selectedProjectData['basicProjectConfigId'] =
      '63284960fdd20276d60e4df5';
    component.getProcessorsTraceLogsForProject('63284960fdd20276d60e4df5');
    expect(httpService.getProcessorsTraceLogsForProject).toHaveBeenCalled();
  });
  ...
  it('should apply filters based on node selection', () => {
    ...
    component.filterForm
      ...
      .setValue('AutoTest1_hierarchyLevelOne');
  ...
  it('should exists lable name for sprint filter', () => {
    ...
    expect(
      component.filterApplyData['selectedMap']['sprint'].length,
    ).toBeGreaterThan(0);
  });
  ...
  it('should redirect on project access from notification for Superadmin and admin', inject(
    [Router],
    (router: Router) => {
      const navigateSpy = spyOn(router, 'navigate');
      spyOn(getAuthorizationService, 'checkIfSuperUser').and.returnValue(true);
  ...
  it('should redirect on User access from notification for Superadmin and admin', inject(
    [Router],
    (router: Router) => {
      const navigateSpy = spyOn(router, 'navigate');
      spyOn(getAuthorizationService, 'checkIfSuperUser').and.returnValue(true);
  ...
  it('should not redirect on User access/project access from notification for Superadmin and admin', inject(
    [Router],
    (router: Router) => {
      const navigateSpy = spyOn(router, 'navigate');
      spyOn(getAuthorizationService, 'checkIfSuperUser').and.returnValue(true);
  ...
  it('navigate to dashboard should call navigateToSelectedTab', () => {
    spyOn(httpService, 'getShowHideOnDashboard').and.returnValue(
      of(configGlobalData),
    );
  ...
  it('should call applyChagnes on selection of trendValue', () => {
    ...
    component.filterForm
      ?.get('selectedTrendValue')
      .setValue('DOTC_63b51633f33fd2360e9e72bd');
  ...
  it('should check if filter already selected for other board', () => {
    ...
    component.initializeFilterForm();
    component.checkIfFilterAlreadySelected();
    expect(component.filterForm.get('selectedTrendValue').value[0]).toEqual(
      'Level1_hierarchyLevelOne',
    );
  });
  ...
  it('should not navigate To Maturity tab', inject(
    [Router],
    (router: Router) => {
      component.selectedTab = 'kpi-maturity';
      component.kanban = false;
  ...
  it('should get project which have atleast one release', () => {
    ...
    component.selectedProjectData['nodeId'] =
      '844_DOTC_63b51633f33fd2360e9e72bd';
    component.initializeFilterForm();
  ...
  it('should get comment summary', fakeAsync(() => {
    ...
    const reqObj = {
      ...
      nodes: ['ADDD_649a920fdf3e6c21e3968e30'],
      nodeChildId: '',
    };
    ...
    component.selectedTab = 'my-knowhow';
    const spy = spyOn(httpService, 'getCommentSummary').and.returnValue(
      of({ success: true, data: 'working' }),
    );
  ...
  it('should get comment summary for iterartion', fakeAsync(() => {
    ...
    const reqObj = {
      level: 5,
      kpiIds: ['kpi14', 'kpi82', 'kpi111', 'kpi35', 'kpi34', 'kpi37', 'kpi28'],
      nodes: ['ADDD_649a920fdf3e6c21e3968e30'],
      nodeChildId: '',
    };
    component.filterApplyData = {
  ...
  it('should update selectedProjectLastSyncDate on fetch data success ', fakeAsync(() => {
    ...
    component.filterForm
      ...
      .setValue('43310_ABFZyDaLnk_64942ed8eb73c425e4d7ba8d');
    ...
    const getActiveIterationStatusSpy = spyOn(
      httpService,
      'getActiveIterationStatus',
    ).and.returnValue(
      of({
        message:
          'Got HTTP response: 200 on url: http://localhost:50008/activeIteration/fetch',
        success: true,
      }),
    );
    ...
    expect(component.selectedProjectLastSyncDate).toEqual(
      '2023-07-21T10:23:51.845',
    );
  }));
  ...
  it('should not update selectedProjectLastSyncDate on fetch data failure ', fakeAsync(() => {
    ...
    const getactiveIterationfetchStatusSpy = spyOn(
      httpService,
      'getactiveIterationfetchStatus',
    ).and.returnValue(
      of({
        message: 'Successfully fetched last sync details from db',
        success: true,
  ...
  it('should toggle filter', () => {
    ...
    const spy = spyOn(sharedService, 'getClickedItem').and.returnValue(
      of(mockTargetElement),
    );
  ...
  it('should set trend value filter when allowMultipleSelection is true', () => {
    ...
    expect(
      component.filterForm['controls']['selectedTrendValue'].value,
    ).toEqual([nodeId]);
  });
  ...
  it('should find project which has data when selectedTab is release', () => {
    ...
    expect(
      component.filterForm['controls']['selectedTrendValue'].value,
    ).toEqual(component.trendLineValueList[len]?.nodeId);
  });
  ...
  it('should get logo image', () => {
    ...
    expect(component.logoImage).toBe(
      'data:image/png;base64,' + logoImage.image,
    );
  });
  ...
  it('should unsubscribe filterKpiRequest', () => {
    ...
    component.kanban = false;
    component.selectedTab = '';
    const filterKpiRequest = jasmine.createSpyObj('Subscription', [
      'unsubscribe',
    ]);
  ...
  it('should filter sprint addtional filter', () => {
    ...
    component.filteredAddFilters = {
      sprint: [{ nodeName: 'sp2' }, { nodeName: 'sp1' }],
    };
  ...
  it('should redirect on login page', inject(
    [Router],
