...
const dashConfigData =
  require('../../../test/resource/fakeShowHideApi.json').data;
...
const completeHierarchyData = {
  kanban: [
    ...
    {
      id: '64c27a5d1d26a19187772c85',
      level: 2,
      hierarchyLevelId: 'hierarchyLevelTwo',
      hierarchyLevelName: 'Business Unit',
    },
    {
      id: '64c27a5d1d26a19187772c86',
      level: 3,
      hierarchyLevelId: 'hierarchyLevelThree',
      hierarchyLevelName: 'Portfolio',
    },
    { level: 4, hierarchyLevelId: 'project', hierarchyLevelName: 'Project' },
    { level: 5, hierarchyLevelId: 'release', hierarchyLevelName: 'Release' },
    { level: 6, hierarchyLevelId: 'afOne', hierarchyLevelName: 'Teams' },
  ],
  scrum: [
    {
      id: '64c27a5d1d26a19187772c84',
    ...
    { level: 4, hierarchyLevelId: 'project', hierarchyLevelName: 'Project' },
    { level: 5, hierarchyLevelId: 'sprint', hierarchyLevelName: 'Sprint' },
    { level: 5, hierarchyLevelId: 'release', hierarchyLevelName: 'Release' },
    { level: 6, hierarchyLevelId: 'afOne', hierarchyLevelName: 'Teams' },
  ],
};
...
const filterApplyData = {
  ...
  selectedMap: {
    ...
    hierarchyLevelTwo: [],
    hierarchyLevelThree: [],
    project: ['Azureproj_64c2a5c930e0c37cd01c2a68'],
    sprint: [],
    release: [],
    afOne: [],
    date: ['DAYS'],
...
describe('DeveloperComponent', () => {
  ...
  it('should pull data for Scrum on load', (done) => {
    ...
    setTimeout(() => {
      httpMock
        .match(baseUrl + '/api/bitbucket/kpi')[0]
        .flush(fakeDeveloperTabData);
      expect(component.bitBucketKpiData).toEqual(
        helperService.createKpiWiseId(fakeDeveloperTabData),
      );
      done();
    }, 500);
  });
  ...
  it('should handle KPI filter change', (done) => {
    ...
    fixture.detectChanges();
    expect(component.kpiSelectedFilterObj['kpi11']).toEqual(
      'debbie_integration -> PSKnowHOW -> KnowHOW',
    );
    done();
  });
  ...
  it('should set the kpiCommentsCountObj for a single kpiId', fakeAsync((
    done,
  ) => {
    const kpiId = 'kpi-1';
    const requestObj = {
  ...
  it('should generate the color object and return the filtered array', () => {
    const kpiId = 'kpi-1';
    const arr = [{ data: 'node-1' }, { data: 'node-2' }, { data: 'node-3' }];
    component.colorObj = {
  ...
  it('shouold  reset data when prject is changing', () => {
    ...
    service.setDashConfigData({
      scrum: [{ boardName: 'developer', kpis: [{ kpiId: 'kpi123' }] }],
    });
  ...
  it('should generate dropdown options', () => {
    ...
    component.colorObj = {
      knowhow: { nodeName: 'knowhow' },
      knowhow2: { nodeName: 'knowhow2' },
    };
    component.allKpiArray = [
      {
        trendValueList: [
          {
            filter: 'f1',
            filter1: 'f4',
            value: [{ data: 'knowhow' }, { data: 'knowhow2' }],
          },
          {
            filter: 'f2',
            filter1: 'f46',
  ...
  it('should populate kpiDropdowns with correct options when trendValueList has filter property', () => {
    ...
    component.allKpiArray = [
      { kpiId: mockKpiId, trendValueList: mockTrendValueList },
    ];
    component.colorObj = {
  ...
  it('should not populate kpiDropdowns when kpiId does not exist in allKpiArray', () => {
    ...
    component.allKpiArray = [
      { kpiId: 'kpi2', trendValueList: mockTrendValueList },
    ];
    component.colorObj = {
      color1: { nodeName: 'branch1' },
      color2: { nodeName: 'branch2' },
