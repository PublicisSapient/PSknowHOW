...
public class ReleasePlanServiceImplTest {
    ...
    public void setUp() {
        ...
        jiraIssues.stream().forEach(jiraIssue -> jiraIssue.setDevDueDate("2023-05-25T05:12:22.0000000"));
        jiraIssues2 = jiraIssueDataFactory.getJiraIssues();
        jiraIssues2.stream().forEach(jiraIssue -> jiraIssue.setDevDueDate("2023-05-25T05:12:22.0000000"));
