...
public class AuthenticationServiceTest {
	...
	public void getMethodTest() {
		...
		Assertions.assertTrue(authService.get(objectId).getId().equals(objectId));
	}
	...
	public void createAuthTest() {
		...
		Assertions.assertTrue(authService.create("test", "Ps123", "ps@test.com").getCredentials() != null);
	}
	...
	public void updateAuthWhenUserDoesNotExists() {
		...
		Assertions.assertTrue(authService.update("test", "Ps123").equals(USER_NOT_FOUND));
	}
	@Test
	public void updateAuth() {
		String UPDATE_SUCCESS = "User is updated";
		when(authRepo.findByUsername("test")).thenReturn(authentication);
		Assertions.assertTrue(authService.update("test", "Ps123").equals(UPDATE_SUCCESS));
	}
	@Test
	...
	public void authenticateTest(){
		...
		{
			Assertions.assertTrue(pendingApprovalMsg.equals(e.getMessage()));
		}
	...
	public void authenticateForAccountLockException(){
		...
		{
			Assertions.assertTrue(lockedExceptionMsg.equals(e.getMessage()));
		}
	...
	public void authenticateForSuccess(){
		...
		when(authRepo.findByUsername("Test")).thenReturn(authentication);
		Assertions.assertTrue(authService.authenticate("Test","Ps123").getCredentials()!=null);
	}
	@Test
	public void authenticateForWrongPassword(){
		...
		{
			Assertions.assertTrue(failed_LoginMsg.equals(e.getMessage()));
		}
	}
	...
	public void changePasswordTest(){
		...
		when(authRepo.findByEmail("ps@test.com")).thenReturn(authenticationList);
		when(authRepo.save(any(Authentication.class))).thenReturn(authentication);
		Assertions.assertTrue(authService.changePassword("ps@test.com","oldpassword").getCredentials()!=null);
	}
	@Test
	public void getAuthenticationTest(){
		when(authRepo.findByUsername("test")).thenReturn(authentication);
		Assertions.assertTrue(authService.getAuthentication("test").getUsername()!=null);
	}
	@Test
	...
	public void getUsernameTest(){
		org.springframework.security.core.Authentication authentication1 = new UsernamePasswordAuthenticationToken("test","TestP");
	...
	public void getAuthNAuthResponseTest(){
		ResponseEntity<ServiceResponse> responseEntity = new ResponseEntity<ServiceResponse>(HttpStatusCode.valueOf(200));
		authService.getAuthNAuthResponse(responseEntity,"test.com");
	}
	@Test
	public void getAuthNAuthResponseWhenError(){
		ResponseEntity<ServiceResponse> responseEntity = new ResponseEntity<ServiceResponse>(HttpStatusCode.valueOf(503));
		authService.getAuthNAuthResponse(responseEntity,"test.com");
	}
