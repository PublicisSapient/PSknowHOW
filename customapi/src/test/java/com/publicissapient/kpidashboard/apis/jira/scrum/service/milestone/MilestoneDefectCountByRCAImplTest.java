...
public class MilestoneDefectCountByRCAImplTest {
	...
	private Map<String, Integer> expectedResult(List<JiraIssue> bugList) {
		...
		Map<String, List<JiraIssue>> collect = bugList.stream().collect(Collectors.groupingBy(jiraIssue->jiraIssue.getRootCauseList().get(0)));
