...
public class FutureSprintLateRefinementServiceImplTest {
    ...
    @InjectMocks
    private FutureSprintLateRefinementServiceImpl futureSprintLateRefinementService;
    ...
    public void testGetKpiDataProject_activeSprint() throws ApplicationException {
        ...
        when(futureSprintLateRefinementService.getRequestTrackerId()).thenReturn(kpiRequestTrackerId);
        try {
    ...
    public void testGetQualifierType() {
        assertThat(futureSprintLateRefinementService.getQualifierType(), equalTo("FUTURE_SPRINT_LATE_REFINEMENT"));
    }
