...
public class UpdateKpiColumnConfigKpi118Kpi183 {
    ...
    public void execution() {
        ...
        Document originalDocumentKpi118 = new Document()
        ...
        Document originalDocumentKpi183 = new Document()
                .append(BASIC_PROJECT_CONFIG_ID, null)
    ...
    public void rollback() {
        ...
        Document newDocumentKpi118 = new Document()
                .append(BASIC_PROJECT_CONFIG_ID, null)
                .append(KPI_ID, KPI_118)
                .append(KPI_COLUMN_DETAILS, List.of(
                        new Document(COLUMN_NAME, PROJECT_NAME).append(ORDER, 1).append(IS_SHOWN, true).append(IS_DEFAULT, true),
                        new Document(COLUMN_NAME, "Job Name / Pipeline Name").append(ORDER, 2).append(IS_SHOWN, true).append(IS_DEFAULT, true),
                        new Document(COLUMN_NAME, "Date").append(ORDER, 3).append(IS_SHOWN, true).append(IS_DEFAULT, true),
        ...
        Document newDocumentKpi183 = new Document()
                .append(BASIC_PROJECT_CONFIG_ID, null)
                .append(KPI_ID, KPI_183)
                .append(KPI_COLUMN_DETAILS, List.of(
                        new Document(COLUMN_NAME, PROJECT_NAME).append(ORDER, 1).append(IS_SHOWN, true).append(IS_DEFAULT, true),
