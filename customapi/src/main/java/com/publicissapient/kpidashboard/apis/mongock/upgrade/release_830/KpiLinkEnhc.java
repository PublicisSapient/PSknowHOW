...
@ChangeUnit(id = "kpi_link_enhc", order = "8333", author = "shunaray", systemVersion = "8.3.3")
	...
	public void execution() {
		...
		updateOrInsertLinkDetail("kpi55","NAME : Ticket Open vs Closed rate by type","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi54","NAME : Ticket Open vs Closed rate by Priority","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi50","NAME : Net Open Ticket Count by Priority","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi51","NAME : Net Open Ticket Count By RCA","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi48","NAME : Net Open Ticket By Status","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi997","NAME : Open Ticket Ageing By Priority","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi63","NAME : Regression Automation Coverage","cat KANBAN: S/Q/V", "");
		updateOrInsertLinkDetail("kpi62","NAME : Unit Test Coverage","cat KANBAN: S/Q/V", "");
		updateOrInsertLinkDetail("kpi64","NAME : Sonar Violations","cat : S/Q/V KANBAN", "");
		updateOrInsertLinkDetail("kpi67","NAME : Sonar Tech Debt","cat : S/Q/V KANBAN", "");
		updateOrInsertLinkDetail("kpi71","NAME : Test Execution and pass percentage","cat KANBAN: S/Q/V", "");
		updateOrInsertLinkDetail("kpi49","NAME : Ticket Velocity","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi58","NAME : Team Capacity","cat : S/Q/V", "");
		updateOrInsertLinkDetail("kpi66","NAME : Code Build Time","cat : S/Q/V KANBAN", "");
		updateOrInsertLinkDetail("kpi65","NAME : Number of Check-ins","cat : KANBAN Developer", "");
		updateOrInsertLinkDetail("kpi53","NAME : Lead Time","cat : KANBAN S/Q/V", "");
		updateOrInsertLinkDetail("kpi74","NAME : Release Frequency","cat : S/Q/V KANBAN", "");
		updateOrInsertLinkDetail("kpi114","NAME : Value delivered (Cost of Delay)","cat KANBAN: S/Q/V", "");
		updateOrInsertLinkDetail("kpi121","NAME : Capacity","cat : Iteration", "");
		...
		updateOrInsertLinkDetail("kpi989","NAME : Kpi Maturity","cat : Kpi Maturity", "");
		...
		updateOrInsertLinkDetail("kpi154","NAME : Daily Standup View","cat : Iteration", "");
		...
		updateOrInsertLinkDetail("kpi159","NAME : Number of Check-ins","cat : KANBAN Developer", "");
