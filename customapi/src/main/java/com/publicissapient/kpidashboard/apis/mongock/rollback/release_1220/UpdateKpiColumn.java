...
/**
 * Change Unit to update columnName from "Job Name" to "Job Name / Pipeline Name" for kpiIds "kpi67, kpi168"
 * @author girpatha
 */
@ChangeUnit(id = "r_update_kpi_column", order = "012206", author = "girpatha", systemVersion = "12.2.0")
