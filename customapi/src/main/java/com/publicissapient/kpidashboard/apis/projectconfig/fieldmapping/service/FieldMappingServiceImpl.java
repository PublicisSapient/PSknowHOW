	...
	private boolean compareJiraData(ObjectId basicProjectConfigId, FieldMapping fieldMapping,
		...
		if (projectBasicConfigOpt.isPresent()) {
			...
			List<String> fieldNameList = Arrays.asList("sprintName", JIRA_DEFECT_TYPE,
					...
					"jiraIterationCompletionStatusKPI145", "jiraIterationCompletionStatusKpi72",
					"jiraIterationCompletionStatusKpi39", "jiraIterationCompletionStatusKpi5",
					"jiraIterationCompletionStatusKPI124", "jiraIterationCompletionStatusKPI123",
					"jiraIterationCompletionStatusKPI125", "jiraIterationCompletionStatusKPI120",
					"jiraIterationCompletionStatusKPI128", "jiraIterationCompletionStatusKPI134",
					"jiraIterationCompletionStatusKPI133", "jiraIterationCompletionStatusKPI119",
					"jiraIterationCompletionStatusKPI131", "jiraIterationCompletionStatusKPI138",
