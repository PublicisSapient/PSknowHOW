...
public class JiraServiceR {
     ...
     * means data availablity in cache required for further processing
     *
     * @param <S>
     * @param projects          all requested projects
     * @param projectsFromCache projects found in cache
     * @param trendValueList    list of data
     * @param kpiCode           kpiCode
     * @param sprintIncluded    list of sprintIncluded
     * @auther deepak
     */
     ...
     * which not found in cache
     *
     * @param <S>
     * @param map
     * @param kpiCode        kpiCode
     * @param sprintIncluded list of sprint Included
     * @auther deepak
     */
    ...
    public class ParallelJiraServices extends RecursiveAction {
        ...
        private <S> void calculateAllKPIAggregatedMetrics(KpiRequest kpiRequest, List<KpiElement> responseList,
            ...
            if (KPICode.THROUGHPUT.equals(kpi)) {
                ...
                //call for checking available data in Cache
                ...
                //call for updating data in Cache
