...
public class RepoToolsClient {
    ...
    public int enrollProjectCall(RepoToolConfig repoToolConfig, String REPO_TOOLSUrl, String apiKey) {
        ...
        ResponseEntity<String> response = restTemplate.exchange(REPO_TOOLSUrl + REPO_TOOLS_ENROLL_URL,
    ...
    public int deleteRepositories(String masterSystemId, String REPO_TOOLSUrl, String apiKey) {
        ...
        ResponseEntity<String> response = restTemplate.exchange(REPO_TOOLSUrl + deleteRepoUrl,
	...
	public int triggerScanCall(String projectKey, String REPO_TOOLSUrl, String apiKey) {
		...
		HttpEntity<String> entity = new HttpEntity<>(httpHeaders);
		ResponseEntity<String> response = restTemplate.exchange(REPO_TOOLSUrl + triggerScanUrl,
    ...
    public List<RepoToolKpiMetricResponse> kpiMetricRepoActivityCall(String projectKey, String REPO_TOOLSKpiUrl, String apiKey) {
        setHttpHeaders(apiKey);
        REPO_TOOLSKpiUrl = String.format(REPO_TOOLSKpiUrl, projectKey);
        HttpEntity<String> entity = new HttpEntity<>(httpHeaders);
        ResponseEntity<RepoToolKpiBulkMetricResponse> response = restTemplate.exchange(REPO_TOOLSKpiUrl,
