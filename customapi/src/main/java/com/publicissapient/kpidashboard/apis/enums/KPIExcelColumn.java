...
public enum KPIExcelColumn {
    ...
    WORK_REMAINING("kpi119",
            Arrays.asList("Issue Id", "Issue Description", "Issue Status", "Issue Type", "Size(story point/hours)", "Remaining Days","Due Date","Predicted Completion Date","Potential Delay(in days)")),
