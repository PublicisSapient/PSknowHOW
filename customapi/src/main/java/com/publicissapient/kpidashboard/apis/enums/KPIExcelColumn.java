...
public enum KPIExcelColumn {
    ...
    DAILY_CLOSURES("kpi125", Arrays.asList("Issue ID", "Issue Type",  "Issue Description", "Size(story point/hours)","Issue Status","Due Date","Predicted Completion Date", "Actual Completion Date","Remaining Estimate","Potential Delay(in days)")),
    ...
    WORK_REMAINING("kpi119",
            Arrays.asList("Issue Id", "Issue Description", "Issue Status", "Issue Type", "Size(story point/hours)", "Original Estimate","Remaining Estimate","Due Date","Predicted Completion Date","Overall Delay")),
