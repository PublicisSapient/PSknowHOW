...
public class JiraIssueRepositoryImpl implements JiraIssueRepositoryCustom {// NOPMD
    ...
    @Override
    public List<SprintWiseStory> findIssuesGroupBySprint(
    ...
    @SuppressWarnings(UNCHECKED)
    @Override
    public List<JiraIssue> findIssueByStoryNumber(
    ...
    @SuppressWarnings(UNCHECKED)
    @Override
    public List<JiraIssue> findIssuesBySprintAndType(
            Map<String, List<String>> mapOfFilters, Map<String, Map<String, Object>> uniqueProjectMap) {
        Criteria criteria = new Criteria();
     ...
     */
    @SuppressWarnings(UNCHECKED)
    private List<Criteria> projectLevelStoryTypeFilters(
    ...
    @SuppressWarnings(UNCHECKED)
    @Override
    public List<JiraIssue> findDefectsWithoutStoryLink(
    ...
    @Override
    public List<JiraIssue> findStoriesBySprints(
            Map<String, List<String>> mapOfFilters, List<String> storyNumber) {
        Criteria criteria = new Criteria();
    ...
    @Override
    @SuppressWarnings(UNCHECKED)
    public List<JiraIssue> findNonRegressionTestCases(
            Map<String, List<String>> mapOfFilters, Map<String, Map<String, Object>> uniqueProjectMap) {
        Criteria criteria = new Criteria();
