...
public interface JiraIssueV2Repository
	...
	@Query("{ 'basicProjectConfigId' : ?0, 'boardId' : ?1, 'key' : { $in: ?2 } }")
	Page<JiraIssueV2> findByProjectIdAndBoardIdAndKeyIn(String basicProjectConfigId, String boardId,
														Set<String> keys, Pageable pageable);
