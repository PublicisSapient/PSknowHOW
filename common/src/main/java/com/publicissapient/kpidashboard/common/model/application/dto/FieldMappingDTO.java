...
public class FieldMappingDTO extends BasicModel {
    ...
    @Builder.Default
    private final String estimationCriteria = "Story Point";

    @Builder.Default
    private final Double storyPointToHourMapping = 8D;

    @Builder.Default
    private final Double workingHoursDayCPT = 6D;
    ...
    //for for JiraDueDate
    @Builder.Default
    private final String jiraDueDateField = CommonConstant.DUE_DATE;
