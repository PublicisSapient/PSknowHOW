...
public class Fields {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("systemIterationId", systemIterationId).append("systemState", systemState).append("systemReason", systemReason).append("systemCreatedDate", systemCreatedDate).append("systemChangedDate", systemChangedDate).append("systemIterationPath", systemIterationPath).append("additionalProperties", additionalProperties).toString();
    }
