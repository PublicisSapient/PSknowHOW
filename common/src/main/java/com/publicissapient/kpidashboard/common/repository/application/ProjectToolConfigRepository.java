...
public interface ProjectToolConfigRepository extends MongoRepository<ProjectToolConfig, ObjectId> {
	...
	/**
	 * Find by toolType -jira, queryEnabled true for jQL and false for board
	 * setup and basicprojectconfig id
	 *
	 * @param tool
	 * @param queryEnabled
	...
	List<ProjectToolConfig> findByToolNameAndQueryEnabledAndBasicProjectConfigIdIn(String tool, boolean queryEnabled,
