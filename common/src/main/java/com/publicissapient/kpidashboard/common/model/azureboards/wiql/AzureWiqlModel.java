...
public class AzureWiqlModel {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("queryType", queryType).append("queryResultType", queryResultType).append("asOf", asOf).append("columns", columns).append("sortColumns", sortColumns).append("workItems", workItems).append("additionalProperties", additionalProperties).toString();
    }
