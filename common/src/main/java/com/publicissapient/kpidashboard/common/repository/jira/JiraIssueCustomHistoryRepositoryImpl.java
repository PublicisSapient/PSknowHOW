...
public class JiraIssueCustomHistoryRepositoryImpl implements JiraIssueHistoryCustomQueryRepository {
    ...
    @Override
    public List<JiraIssueCustomHistory> findFeatureCustomHistoryStoryProjectWise(Map<String, List<String>> mapOfFilters, Map<String, Map<String, Object>> uniqueProjectMap) {
        ...
        Criteria criteriaAggregatedForFirstMatchStage = new Criteria().andOperator(criteria, criteriaAggregatedAtProjectLevel);
        ...
        Criteria criteriaAggregatedAtProjectLevelForStatus = new Criteria().orOperator(storyStatuscriteriaList.toArray(new Criteria[0]));
        ...
        List<IssueHistoryMappedData> data = operations.aggregate(agg, JiraIssueCustomHistory.class, IssueHistoryMappedData.class).getMappedResults();
     ...
     */
    @Override
    public List<JiraIssueCustomHistory> findIssuesByCreatedDateAndType(Map<String, List<String>> mapOfFilters, Map<String, Map<String, Object>> uniqueProjectMap, String dateFrom, String dateTo) {
