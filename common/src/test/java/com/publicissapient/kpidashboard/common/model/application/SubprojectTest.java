...
public class SubprojectTest {
	// Field toolConfigId of type ObjectId - was not mocked since Mockito doesn't
	...
	public void testEquals() throws Exception {
		boolean result = subproject.equals("o");
		Assert.assertEquals(false, result);
	}

	@Test
	public void testCanEqual() throws Exception {
		boolean result = subproject.canEqual("other");
		Assert.assertEquals(false, result);
	}

	@Test
	public void testToString() throws Exception {
		String result = subproject.toString();
		Assert.assertNotNull(result);
	}

	@Test
	public void testSetToolConfigId() throws Exception {
		subproject.setToolConfigId(null);
	}

	@Test
	public void testSetBasicProjectConfigId() throws Exception {
		subproject.setBasicProjectConfigId(null);
	}

	@Test
	public void testSetSubProjectIdentification() throws Exception {
		subproject.setSubProjectIdentification("subProjectIdentification");
	}

	@Test
	public void testSetSubProjectIdentMultiValue() throws Exception {
		subproject.setSubProjectIdentMultiValue(Arrays.<String>asList("String"));
	}

	@Test
	public void testSetSubProjectIdentSingleValue() throws Exception {
		subproject.setSubProjectIdentSingleValue("subProjectIdentSingleValue");
	}

	@Test
	public void testSetSubProjectUserProvided() throws Exception {
		subproject.setSubProjectUserProvided(
	...
	public void testBuilder() throws Exception {
		Subproject.SubprojectBuilder result = Subproject.builder();
		Assert.assertNotNull(result);
	}
