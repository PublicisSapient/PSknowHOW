...
public class DataCountGroupTest {
	@Mock
	...
	public void testSetFilter1() throws Exception {
		dataCountGroup.setFilter1("filter1");
	}

	@Test
	public void testSetFilter2() throws Exception {
		dataCountGroup.setFilter2("filter2");
	}

	@Test
	public void testSetValue() throws Exception {
		dataCountGroup.setValue(Arrays.<DataCount>asList(
	...
	public void testSetAggregationValue() throws Exception {
		dataCountGroup.setAggregationValue("aggregationValue");
	}

	@Test
	public void testSetDuration() throws Exception {
		dataCountGroup.setDuration("duration");
	}

	@Test
	public void testToString() throws Exception {
		String result = dataCountGroup.toString();
