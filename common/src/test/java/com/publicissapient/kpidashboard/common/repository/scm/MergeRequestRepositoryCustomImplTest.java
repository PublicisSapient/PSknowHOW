...
public class MergeRequestRepositoryCustomImplTest {
    ...
    public void testFindMergeList() {
        ...
        List<MergeRequests> result = mergeRequestRepositoryCustomImpl.findMergeList(collectorItemIdList, startDate,
                endDate, filterList);
    ...
    public void testFindMergeRequestList() {
        ...
        // Add filter criteria to filterList
        // Call the method and assert the result
        List<MergeRequests> result = mergeRequestRepositoryCustomImpl.findMergeRequestList(collectorItemIdList,
                startDate, endDate, filterList);
