...
import com.publicissapient.kpidashboard.jira.service.FetchSprintV2Report;
...
@Slf4j
@Service
public class SprintV2DataProcessorImpl implements SprintV2DataProcessor {

	@Autowired
	private FetchSprintV2Report fetchSprintV2Report;

	@Override
	public Set<SprintDetailsV2> processSprintV2Data(Issue issue, ProjectConfFieldMapping projectConfig, String boardId)
			throws IOException {
		...
		if (StringUtils.isEmpty(boardId)) {
			return fetchSprintV2Report.fetchSprintV2s(projectConfig, sprintDetailsSet, krb5Client, false);
		}
