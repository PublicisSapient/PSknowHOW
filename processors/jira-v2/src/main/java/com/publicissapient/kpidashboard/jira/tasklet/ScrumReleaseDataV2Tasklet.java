...
import com.publicissapient.kpidashboard.jira.service.FetchScrumReleaseV2Data;
...
@Component
@StepScope
public class ScrumReleaseDataV2Tasklet implements Tasklet {
	@Autowired
	...
	@Autowired
	FetchScrumReleaseV2Data fetchScrumReleaseV2Data;
	...
	public RepeatStatus execute(StepContribution sc, ChunkContext cc) throws Exception {
		...
		try (ProcessorJiraRestClient client = jiraClient.getClient(projConfFieldMapping, krb5Client);) {
			fetchScrumReleaseV2Data.processReleaseV2Info(projConfFieldMapping, krb5Client);
		}
