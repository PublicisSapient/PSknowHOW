...
public class AlphanumComparator implements Comparator<File> {
    ...
    /**
     * Gets a chunk of String that is passed to the method,
     * starting from the location of marker.
     *
    ...
    /**
     * Compares two files based on the chunk of the name
     * which is a string, if the chunk contains
     * digits then the method compares it char by char
     *
     * @param file1 this File to compare
     * @param file2 that File to compare
     * @return 0 if thisChunk and thatChunk are equal,-1 if thisChunk
     * is smaller,1 if thisChunk is bigger
     */
    @Override
