...
public class MetaDataClientImpl implements MetadataClient {
	...
	private FieldMapping mapFieldMapping(Map<String, List<String>> issueTypeMap, Map<String, List<String>> workflowMap,
		...
		fieldMapping.setJiraIterationCompletionStatusICO(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusWR(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusPWS(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusUPWS(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusILS(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIW(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusQS(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIDCR(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIFTPR(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusCPT(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusEVA(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusDCS(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIDCP(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIDCR(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIDCS(workflowMap.get(CommonConstant.DOD));
		...
		fieldMapping.setJiraIterationCompletionStatusEH(workflowMap.get(CommonConstant.DOD));
		fieldMapping.setJiraIterationCompletionStatusIBU(workflowMap.get(CommonConstant.DOD));
		...
		fieldMapping.setResolutionTypeForRejectionQS(valuesToIdentifyMap.get(CommonConstant.REJECTION_RESOLUTION));
