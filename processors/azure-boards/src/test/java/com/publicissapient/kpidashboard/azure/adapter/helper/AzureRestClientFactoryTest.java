...
public class AzureRestClientFactoryTest {
    ...
    public void cacheRestClient() throws Exception { //NOSONAR
        ...
        Mockito.when(restTemplate.exchange(ArgumentMatchers.any(URI.class), ArgumentMatchers.eq(HttpMethod.GET), ArgumentMatchers.eq(entity), ArgumentMatchers.eq(String.class))).thenReturn(response);
