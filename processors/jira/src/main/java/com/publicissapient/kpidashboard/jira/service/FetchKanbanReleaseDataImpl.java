...
public class FetchKanbanReleaseDataImpl implements FetchKanbanReleaseData {
    ...
    @Override
    public ProjectRelease processReleaseInfo(ProjectConfFieldMapping projectConfig, KerberosClient krb5Client) throws IOException, ParseException {
    ...
    private void saveProjectRelease(ProjectConfFieldMapping confFieldMapping,
                                    KanbanAccountHierarchy kanbanAccountHierarchy, ProjectRelease projectRelease, KerberosClient krb5Client) throws IOException, ParseException {
