...
public interface FetchSprintReport {
    ...
    List<SprintDetails> fetchSprints(ProjectConfFieldMapping projectConfig, Set<SprintDetails> sprintDetailsSet, Set<SprintDetails> setForCacheClean, KerberosClient krb5Client, boolean isSprintFetch) throws InterruptedException;
