...
import com.publicissapient.kpidashboard.jira.data.KanbanJiraIssueDataFactory;
...
public class CreateKanbanJiraIssueHistoryImplTest {

    @InjectMocks
    private CreateKanbanJiraIssueHistoryImpl createJiraIssueHistory;
    ...
    public void setUp() throws URISyntaxException {
        ...
        FieldMappingDataFactory fieldMappingDataFactory = FieldMappingDataFactory.newInstance("/json/default/kanban_project_field_mappings.json");
