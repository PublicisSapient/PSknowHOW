...
public class OfflineDataProcessorImplTest {
	...
	private KanbanAccountHierarchyRepository kanbanAccountHierarchyRepo = Mockito
	...
	public void validateAndCollectIssues() throws Exception {
		...
		when(jiraIssueClientFactory.getJiraIssueDataClient(any(ProjectConfFieldMapping.class)))
				.thenReturn(kanbanJiraIssueClient);
