...
public class MongoConfig {
	 ...
	 */
	@Bean
	public MongoClient mongoClient(AesEncryptionService aesEncryptionService, BambooConfig bambooConfig) {
		password = aesEncryptionService.decrypt(password, bambooConfig.getAesEncryptionKey());
