...
package com.publicissapient.kpidashboard.bamboo.data;
 ...
 */
@Slf4j
public class ProcessorToolConnectionFactory {
	...
	private ProcessorToolConnectionFactory() {
	}

	public static ProcessorToolConnectionFactory newInstance(String filePath) {

		ProcessorToolConnectionFactory factory = new ProcessorToolConnectionFactory();
		factory.createObjectMapper();
		factory.init(filePath);
		return factory;
	}

	public static ProcessorToolConnectionFactory newInstance() {
